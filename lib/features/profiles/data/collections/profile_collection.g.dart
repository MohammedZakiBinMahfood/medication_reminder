...
void _profileCollectionSerialize(
  ...
  writer.writeLong(offsets[0], object.avatarIconCodePoint);
...
ProfileCollection _profileCollectionDeserialize(
  ...
  object.avatarIconCodePoint = reader.readLong(offsets[0]);
...
extension ProfileCollectionByIndex on IsarCollection<ProfileCollection> {
  Future<ProfileCollection?> getByUuid(String uuid) {
    return getByIndex(r'uuid', [uuid]);
  }

  ProfileCollection? getByUuidSync(String uuid) {
  ...
  Future<List<ProfileCollection?>> getAllByUuid(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
    return getAllByIndex(r'uuid', values);
  }

  List<ProfileCollection?> getAllByUuidSync(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
  ...
  Future<Id> putByUuid(ProfileCollection object) {
    return putByIndex(r'uuid', object);
  }

  Id putByUuidSync(ProfileCollection object, {bool saveLinks = true}) {
    return putByIndexSync(r'uuid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByUuid(List<ProfileCollection> objects) {
...
extension ProfileCollectionQueryFilter
  ...
  avatarIconCodePointEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'avatarIconCodePoint', value: value),
      );
    });
  }

  QueryBuilder<ProfileCollection, ProfileCollection, QAfterFilterCondition>
  avatarIconCodePointGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<ProfileCollection, ProfileCollection, QAfterFilterCondition>
  avatarIconCodePointLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
...
extension ProfileCollectionQueryWhereDistinct
  ...
  QueryBuilder<ProfileCollection, ProfileCollection, QDistinct> distinctByUuid({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ProfileCollectionQueryProperty
  ...
  QueryBuilder<ProfileCollection, String, QQueryOperations> colorProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProfileCollection, bool, QQueryOperations> isDefaultProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isDefault');
    });
  }

  QueryBuilder<ProfileCollection, bool, QQueryOperations> isDeletedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProfileCollection, int, QQueryOperations> sortOrderProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProfileCollection, String, QQueryOperations> uuidProperty() {
    return QueryBuilder.apply(this, (query) {
